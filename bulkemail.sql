...
CREATE TABLE Email_Group (
    ...
    Description TEXT,
    Criteria ENUM('Company', 'Gender', 'Age')
);
...
-- user-defined datatype and table extension
ALTER TABLE RecipientList
ADD COLUMN Subscription ENUM('subscribed', 'unsubscribed');
ALTER TABLE email DROP COLUMN DeliveryStatus;
ALTER TABLE email
ADD COLUMN DeliveryStatus ENUM('bounced', 'delivered', 'opened');
